...
public class DashboardActivity extends AppCompatActivity {
    ...
    TextView tvWelcome, tvUserInitial, tvTotalCerts, tvVerifiedCerts, tvPendingCerts;
    ImageView ivLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotalCerts = findViewById(R.id.tv_total_certs);
        tvVerifiedCerts = findViewById(R.id.tv_verified_certs);
        tvPendingCerts = findViewById(R.id.tv_pending_certs);
        ...
        new Thread(() -> {
            try {
                ...
                if (jsonResponse.getString("status").equals("success")) {
                    runOnUiThread(() -> {
                        try {
                            tvTotalCerts.setText(String.valueOf(jsonResponse.getInt("total_certificates")));
                            tvVerifiedCerts.setText(String.valueOf(jsonResponse.getInt("verified_certificates")));
                            tvPendingCerts.setText(String.valueOf(jsonResponse.getInt("pending_certificates")));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    });
                    ...
                    runOnUiThread(() -> {
                        try {
                            Toast.makeText(DashboardActivity.this, jsonResponse.getString("message"),
